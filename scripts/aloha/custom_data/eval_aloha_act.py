#!/usr/bin/env python
"""Evaluate an ACT policy trained on the local ALOHA-format dataset."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--policy-path", default="/home/liyi/lerobot/outputs/train/aloha_lerobot_act_v3_10000")
    parser.add_argument("--output-dir", default="outputs/eval/aloha_lerobot_act_v3_10000")
