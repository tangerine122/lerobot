#!/usr/bin/env python
"""Train an ACT policy on a local LeRobot v3.0 ALOHA-format dataset."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dataset-repo-id", default="local/aloha_lerobot")
    parser.add_argument("--dataset-root", default="/home/liyi/lerobot/scripts/aloha_lerobot")
    parser.add_argument("--dataset-revision", default="v3.0")
    parser.add_argument("--output-dir", default="outputs/train/aloha_lerobot_act_v3")
...
def main() -> None:
    ...
    # Do not add observation.state to delta_timestamps for ACT. The dataset should return
    # current state as [batch, state_dim], while action chunks are [batch, chunk, action_dim].
    delta_timestamps = {
