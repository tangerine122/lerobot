#!/usr/bin/env python
"""Evaluate an ACT policy on the official ALOHA transfer-cube simulation."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--policy-path", default="/home/liyi/lerobot/outputs/train/aloha_transfer_cube_act_v3_10000")
    parser.add_argument("--output-dir", default="outputs/eval/aloha_transfer_cube_act_v3_10000")
    ...
    parser.add_argument("--env-task", default="AlohaTransferCube-v0")
    ...
    parser.add_argument("--observation-height", type=int, default=480)
    parser.add_argument("--observation-width", type=int, default=640)
...
def main() -> None:
    ...
    try:
        ...
        print(f"env_task={args.env_task}")
        print(f"device={device} n_episodes={args.n_episodes} batch_size={args.batch_size}")
        print(f"observation_size={args.observation_height}x{args.observation_width}")
        print(f"episode_length={args.episode_length} max_videos={args.max_videos}")
