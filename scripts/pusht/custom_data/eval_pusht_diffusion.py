#!/usr/bin/env python
"""Evaluate a policy trained on the local exporter PushT-format dataset."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--policy-path", default="/home/liyi/lerobot/outputs/train/custom/exporter_diffusion_v3_5000")
    parser.add_argument("--output-dir", default="outputs/eval/custom/exporter_diffusion_v3_5000")
